...
class PlatformCatalogTest extends TestCase
{
    ...
    {
        $this->assertSame(
            ['accounting', 'hr', 'inventory', 'purchase', 'sales'],
    ...
    public function test_license_packages_map_to_correct_module_sets(): void
    {
        $expected = [
            'Başlangıç' => ['inventory'],
            'Standart' => ['hr', 'inventory', 'purchase', 'sales'],
            'Premium' => ['accounting', 'hr', 'inventory', 'purchase', 'sales'],
        ];
    ...
    public function test_seeders_are_idempotent(): void
    {
        ...
        $this->assertSame(5, Module::count());
