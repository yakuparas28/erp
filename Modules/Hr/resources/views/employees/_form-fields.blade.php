...
<div class="p-4 grid grid-cols-1 sm:grid-cols-2 gap-3">
    @if ($employee)
        <div class="sm:col-span-2 p-3 bg-light border border-border-color rounded-md text-sm">
            <div class="text-xs text-default mb-0.5">{{ __('System User') }}</div>
            <div class="text-title font-mono">{{ $employee->user?->email ?? '—' }}</div>
        </div>
    @else
        <div class="sm:col-span-2">
            <label class="block text-sm font-semibold text-gray-900 mb-1">{{ __('Email') }} <span class="text-danger">*</span></label>
            <input type="email" name="email" value="{{ old('email') }}" class="w-full px-3 py-2 text-sm border border-border-color rounded-md bg-white focus:outline-none focus:ring-0" required maxlength="255" placeholder="ad.soyad@firma.com">
            <p class="text-xs text-default mt-1 mb-0">{{ __('A system user with this email will be created automatically.') }}</p>
        </div>
    @endif

    <div>
        <label class="block text-sm font-semibold text-gray-900 mb-1">{{ __('First Name') }} <span class="text-danger">*</span></label>
    ...
    <div>
        <label class="block text-sm font-semibold text-gray-900 mb-1">{{ __('Last Name') }} <span class="text-danger">*</span></label>
    ...
    <div>
        <label class="block text-sm font-semibold text-gray-900 mb-1">{{ __('Title') }}</label>
    ...
    <div>
        <label class="block text-sm font-semibold text-gray-900 mb-1">{{ __('Department') }}</label>
    ...
    <div>
        <label class="block text-sm font-semibold text-gray-900 mb-1">{{ __('Manager') }}</label>
    ...
    <div>
        <label class="block text-sm font-semibold text-gray-900 mb-1">{{ __('Hire Date') }}</label>
    ...
    <div>
        <label class="block text-sm font-semibold text-gray-900 mb-1">{{ __('Birth Date') }}</label>
    ...
    <div>
        <label class="block text-sm font-semibold text-gray-900 mb-1">{{ __('National ID') }}</label>
    ...
    <div>
        <label class="block text-sm font-semibold text-gray-900 mb-1">{{ __('Mobile') }}</label>
    ...
    <div>
        <label class="block text-sm font-semibold text-gray-900 mb-1">{{ __('Annual Leave Balance') }}</label>
