        ...
        <form method="POST" action="{{ $action }}" class="flex flex-col bg-white border shadow-sm rounded-md border-border-color w-full">
            ...
            <div class="p-4 grid grid-cols-12 gap-3">
                <div class="col-span-12">
                    ...
                    <input type="text" name="name" required value="{{ $partner?->name }}" class="w-full px-3 py-2 text-sm border border-border-color rounded-md bg-white focus:outline-none focus:ring-0">
                </div>
                <div class="col-span-12 sm:col-span-6">
                    <label class="text-sm font-semibold text-gray-900 mb-1 block">{{ __('Tax Number') }}</label>
                    <input type="text" name="tax_number" value="{{ $partner?->tax_number }}" class="w-full px-3 py-2 text-sm border border-border-color rounded-md bg-white focus:outline-none focus:ring-0">
                </div>
                <div class="col-span-12 sm:col-span-6">
                ...
                <div class="col-span-12 sm:col-span-6 flex items-center gap-2">
                    ...
                    <label for="is_customer_{{ $id }}" class="text-sm text-default">{{ __('Customer') }}</label>
                </div>
                <div class="col-span-12 sm:col-span-6 flex items-center gap-2">
                    ...
                    <label for="is_supplier_{{ $id }}" class="text-sm text-default">{{ __('Supplier') }}</label>
                </div>
            </div>
